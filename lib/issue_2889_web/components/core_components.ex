defmodule Issue2889Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Issue2889Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Issue2889Web.Gettext, "errors", msg, opts)
    end
  end
